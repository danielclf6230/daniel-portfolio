const timelineElements = [
  ...
  },
  {
    ...
    location: 'Southern Alberta Institute of Technology, Calgary',
    description: [
      'Studied Java, JavaScript, SQL, PL/SQL, HTML, CSS, networking, and cybersecurity.',
      'Self-learned additional technologies including React, Socket.io, and Python.',
    ],
  ...
  },
  {
    ...
    location: 'Hong Kong',
    description: [
      'Provided end-user support for PC hardware, software, and operating systems.',
      'Managed company website and performed user acceptance testing (UAT) with clients.',
      'Administered network infrastructure including IP phone systems and firewall configurations.',
